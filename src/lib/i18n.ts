...
const en = {
  ...
  'meta.ireland.title': 'Flight Compensation in Ireland — ClaimVelo | Claim Up to €600',
  'meta.ireland.desc': 'Delayed or cancelled flight from Dublin, Cork or Shannon? Claim up to €600 under EU Regulation 261/2004. No win, no fee. Irish passengers — start your free check today.',
  'meta.partners.title': 'Partner with ClaimVelo — Refer Passengers, Earn Commission',
  'meta.partners.desc': 'Join the ClaimVelo partner programme. Refer passengers with delayed or cancelled flights and earn commission on every successful claim.',
  'nav.home': 'Home',
  'nav.about': 'About Us',
